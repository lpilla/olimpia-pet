import {
  ...
  DialogBody,
  DialogFooter,
  Button, Typography, CardHeader, CardBody, Chip,
  ...
  return (
      ...
      >
        ...
        >
          ...
          <DialogBody className={"p-0"}> <Card className="flex-row w-full max-w-[48rem] p-0 rounded-none shadow-none">
            <CardHeader shadow={false} floated={false} className="w-2/5 shrink-0 m-0 rounded-none">
              <img
                  src={marker.icon}
                  alt="image"
